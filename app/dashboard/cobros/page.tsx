    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg border border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Total Cobros</p>
              <p className="text-2xl font-bold text-gray-900">{totalCobros}</p>
            </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="text-center text-sm text-gray-600">
            Mostrando {startIndex + 1} a {Math.min(endIndex, filteredCobros.length)} de {filteredCobros.length} cobros
          </div>
        </>
      )}
